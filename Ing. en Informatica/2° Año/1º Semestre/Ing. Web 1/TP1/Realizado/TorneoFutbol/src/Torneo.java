...
public class Torneo {
    ...
    protected List<Partido> encuentros;
    ...
    public void setEncuentros(List<Partido> encuentros){
        // TO DO Inicializar partidos del torneo
        this.encuentros = encuentros;
        proximaFechaIterator = encuentros.iterator();
        proximaFecha = proximaFechaIterator.hasNext() ? proximaFechaIterator.next() : null;
    }
