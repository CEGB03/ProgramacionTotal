...
public class Partido {
    ...
    public Partido (Equipo equipo1, Equipo equipo2){
        // T ODO Implementar constructor (inicializar colecciones)
        if (equipo1.getNombre().equals(equipo2.getNombre())) {
            System.out.println("No se puede enfrentar el mismo equipo en un partido");
            throw new IllegalArgumentException("Partido Imposible");
        }
    ...
    public void addGol (Equipo e) {
        // TO DO Implementar cuenta de goles
        estado.addGol(e);
        //goles.put(e, goles.get(e) + 1);
        e.addGol();
    }
    ...
    public void setFinalizado () {
        // TO DO Implementar actualizacion de partidos disputados y puntajes
        // No modificar la siguiente linea
    ...
    private class Finalizado extends Estado {
         ...
         */
        public void CalcularPuntajes (){
            // TO DO Implementar la asignacion de puntajes a los equipos
            int golesEquipo1 = goles.getOrDefault(equipo1, 0);
            int golesEquipo2 = goles.getOrDefault(equipo2, 0);        
            if (golesEquipo1 > golesEquipo2) {
                equipo1.addPuntaje(3);
                equipo2.addPuntaje(0);
            } else if (golesEquipo1 < golesEquipo2) {
                equipo2.addPuntaje(3);
                equipo1.addPuntaje(0);
            } else {
