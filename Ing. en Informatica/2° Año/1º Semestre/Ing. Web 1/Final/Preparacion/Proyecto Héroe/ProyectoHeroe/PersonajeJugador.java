...
public class PersonajeJugador extends Personaje implements Guerrero {
    ...
    class MisionNoAsignada extends EstadoMision {
        ...
        public void asignarMision(PersonajeJugador p) {
            ...
            p.asignarMision(mision);
        }

        @Override
        public void aceptarMision(PersonajeJugador p) {
            // TO DO - Implementar el metodo
            throw new IllegalStateException("La misión no ha sido asignada.");
        }
    ...
    class MisionAsignada extends EstadoMision {
        ...
        public void asignarMision(PersonajeJugador p) {
            // TO DO - Implementar el metodo
            throw new IllegalStateException("La misión ya ha sido asignada.");
        }
        ...
        public void aceptarMision(PersonajeJugador p) {
            ...
            if (p.getNivel() >= p.getMision().getNivelRequerido()) {
                ...
                throw new IllegalStateException("Nivel insuficiente para aceptar la misión.");
            }
        }
        @Override
        public void cumplirMision(PersonajeJugador p) {
            // TO DO - Implementar el metodo
            throw new IllegalStateException("La misión aún no ha sido aceptada.");
        }
    }
    ...
    class MisionAceptada extends EstadoMision {
        ...
        public void aceptarMision(PersonajeJugador p) {
            // TO DO - Implementar el metodo
            throw new IllegalStateException("La misión ya ha sido aceptada.");
        }
        ...
        public void cumplirMision(PersonajeJugador p) {
            // TO DO - Implementar el metodo
            if (p.getEstadoMision()==p.getEstadoMision()) {
                p.cumplirMision();
                p.isMisionFinalizada();
            } else {
                throw new IllegalStateException("La misión aún no está completa.");
            }
        }
    }
    ...
    class MisionFinalizada extends EstadoMision {
        ...
        public void asignarMision(PersonajeJugador p) {
            // TO DO - Implementar el metodo
            throw new IllegalStateException("La misión ya ha sido finalizada.");
        }
