...
#include <stdlib.h>
#include <string.h>
#define Tam_Buqueda_Palabras 3
#define Tam_Buqueda_Quijote 13
#define Tam_Buqueda_Rocinante 4
#define Tam_Buqueda_Sancho 13
#define Quijote 848
...
int main(){
	...
	static const char 
		*Busqueda_Quijote[Tam_Buqueda_Quijote]={"QUIJOTE","Quijote","Quijote,","Quijote.","Quijote!","Quijote?","Quijote:","Quijote;","Quijote-","Quijote-.","Quijote-,","Quijote-;","Quijote-:"},
		*Busqueda_Rocinante[Tam_Buqueda_Rocinante]={"Rocinante","Rocinante,","Rocinante.","Rocinante;"},
		*Busqueda_Sancho[Tam_Buqueda_Sancho]={"SANCHO","Sancho","Sancho,","Sancho.","Sancho!","Sancho?","Sancho:","Sancho;","Sancho-","Sancho-.","Sancho-,","Sancho-;","Sancho-:"};
	char Cadenas_Recuperada[60];
	int Repeticiones[Tam_Buqueda_Palabras]={0}, Repeticiones_Q[Tam_Buqueda_Quijote]={0}, Repeticiones_R[Tam_Buqueda_Rocinante]={0}, Repeticiones_S[Tam_Buqueda_Sancho]={0};
	if(P_Archivo_4==NULL){
